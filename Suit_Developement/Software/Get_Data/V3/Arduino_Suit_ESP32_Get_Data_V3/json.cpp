...
String buildJson()
{
    ...
    for(uint8_t i=0;i<NUM_IMUS;i++)
    {
        ...
        // --- Primary orientation: quaternion ----

        json += "\"qw\":";
        json += String(allReadings[i].quat.w,4);
        json += ",";

        json += "\"qx\":";
        json += String(allReadings[i].quat.x,4);
        json += ",";

        json += "\"qy\":";
        json += String(allReadings[i].quat.y,4);
        json += ",";

        json += "\"qz\":";
        json += String(allReadings[i].quat.z,4);
        json += ",";
