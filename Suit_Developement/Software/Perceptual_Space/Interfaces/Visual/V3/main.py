...
# Disable per-call error checking: it roughly doubles the
# cost of every GL call in immediate mode. Re-enable when
...
def run_opengl():
    ...
    while running:
        ...
        # Surface the connection state in the window title so a
        # frozen pose is distinguishable from a still performer.
        if fresh:
