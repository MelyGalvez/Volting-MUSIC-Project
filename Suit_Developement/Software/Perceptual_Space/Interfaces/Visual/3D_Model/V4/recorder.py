...
class Recorder:
    ...
    The columns follow the wire format: orientation is the
    Euler triplet the ESP32 transmits, next to the calibration
    flag that tells a T-pose-relative reading apart from an
    absolute one.
